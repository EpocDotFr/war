...
OBJECT_STORE = {'AUTH_URL': 'https://auth.example.com/v2.0', 'CONTAINER_URL': 'https://example.com', 'TENANT_ID': 'ahah', 'TENANT_NAME': 'ahah', 'USERNAME': 'ahah', 'PASSWORD': 'ahah', 'REGION_NAME': 'XXX'}
